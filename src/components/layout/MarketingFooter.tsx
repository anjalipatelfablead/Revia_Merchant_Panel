...
export const MarketingFooter: React.FC<Props> = ({ onNavigate }) => {
   return (
               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-7">
                  ...
                  <div>
                     ...
                     <ul className="space-y-4 text-[15px] font-medium text-gray-600">
                        <li>
                           <a href="#features" onClick={(e) => { e.preventDefault(); onNavigate?.('/'); }} className="flex items-center gap-3 hover:text-[#D9A94E] transition-colors group">
                  ...
                  <div>
                     ...
                     <ul className="space-y-4 text-[15px] font-medium text-gray-600">
                        <li>
                           <a href="#" onClick={(e) => { e.preventDefault(); onNavigate?.('/about'); }} className="flex items-center gap-3 hover:text-[#D9A94E] transition-colors group">
                              <Users className="w-4 h-4 text-[#D9A94E] opacity-70 group-hover:opacity-100 transition-opacity shrink-0" />
                              About Us
                           </a>
                        </li>
                        <li>
                           <a href="#" onClick={(e) => { e.preventDefault(); onNavigate?.('/contact'); }} className="flex items-center gap-3 hover:text-[#D9A94E] transition-colors group">
                              <Megaphone className="w-4 h-4 text-[#D9A94E] opacity-70 group-hover:opacity-100 transition-opacity shrink-0" />
                              Contact
                           </a>
                        </li>
                        <li>
                           <a href="#" onClick={(e) => { e.preventDefault(); onNavigate?.('/privacy'); }} className="flex items-center gap-3 hover:text-[#D9A94E] transition-colors group">
                              <Lock className="w-4 h-4 text-[#D9A94E] opacity-70 group-hover:opacity-100 transition-opacity shrink-0" />
                              Privacy Policy
                           </a>
                        </li>
                        <li>
                           <a href="#" onClick={(e) => { e.preventDefault(); onNavigate?.('/terms'); }} className="flex items-center gap-3 hover:text-[#D9A94E] transition-colors group">
