...
import { Star, Gift, Users, Store, ArrowRight, ChevronLeft, ChevronRight, BarChart2, TrendingUp, Calendar, MapPin, Sparkles, QrCode, Utensils, Award, Clock, ChevronDown } from 'lucide-react';
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-between space-y-6">
          <div className="space-y-3">
            ...
            <p className="text-sm md:text-base text-white/70 max-w-md">
              You are just <strong>2 visits away</strong> from unlocking your next free Artisanal Beverage.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-xl font-black text-[#222]">My Loyalty Cards</h3>
              </div>
