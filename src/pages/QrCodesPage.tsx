                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-4 mb-2">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          <button className="p-1.5 text-[#9E9A93] hover:text-[#1A1615] rounded bg-[#FAF8F5] transition-colors"><Edit2 className="w-3.5 h-3.5" /></button>
                          <button className="p-1.5 text-[#9E9A93] hover:text-[#1A1615] rounded bg-[#FAF8F5] transition-colors"><Download className="w-3.5 h-3.5" /></button>
                          <button className="p-1.5 text-[#9E9A93] hover:text-[#1A1615] rounded bg-[#FAF8F5] transition-colors"><MoreHorizontal className="w-3.5 h-3.5" /></button>
                        </div>
                      </div>
          ...
          <div className="bg-white rounded-xl border border-[#EFECE6] shadow-sm overflow-hidden flex flex-col h-[calc(100vh-8rem)]">
            ...
            <div className="px-5 py-4 border-b border-[#EFECE6] bg-[#FAF8F5] shrink-0">
              ...
              <div className="flex p-0.5 bg-[#EFECE6] rounded-lg">
                <button className="flex-1 px-3 py-1.5 text-xs font-bold rounded-md bg-white shadow-xs text-[#1A1615] transition-all">
                  Front Side
                </button>
                <button className="flex-1 px-3 py-1.5 text-xs font-bold rounded-md text-[#6E6A66] hover:text-[#1A1615] transition-all">
                  Back Side
                </button>
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-5 bg-[#FDFBF7]">
              ...
              <div className="flex justify-center mb-8">
                <div className="w-[240px] bg-white rounded-t-[16px] shadow-2xl border border-[#EFECE6] relative overflow-hidden flex flex-col items-center pt-6 pb-4">
                  ...
                  <h4 className="text-center text-[15px] font-black text-[#1A1615] leading-tight px-6 z-10">SCAN TO JOIN REVIA PRIVÉ</h4>
                  <p className="text-center text-[10px] font-semibold text-[#6E6A66] px-8 mt-2 mb-6 z-10 leading-snug">
                    Unlock complimentary artisanal pour-over on your next reservation.
                  </p>
